package givehallo //untuk menandakan ini adalah package. nama package itu sama seperti nama folder tempat file disimpan

import "fmt"

//isi dari package
//untuk pemanggilannya bisa di cek di package.go
func SayHello(nama string) string { //function
